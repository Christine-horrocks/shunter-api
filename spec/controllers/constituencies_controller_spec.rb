...
RSpec.describe ConstituenciesController, vcr: true do
  describe 'GET show' do
    ...
    it 'assigns @constituency, @seat_incumbencies, @current_incumbency, @json_location and @member' do
      ...
      expect(assigns(:member)).to be_a(Grom::Node)
      expect(assigns(:member).type).to eq('https://id.parliament.uk/schema/Person')
